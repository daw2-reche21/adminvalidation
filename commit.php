...
case 'add':
    ...
    case 'people':
       ...
       $isactor=isset($_POST['people_isactor'])?$_POST['people_isactor']:0;
       $isdirector=isset($_POST['people_isdirector'])?$_POST['people_isdirector']:0;
       if($isactor==0 && $isdirector==0){
            $error[]=urlencode('Please select actor, director or both');
       }
       if (empty($error)) {
            $query = 'INSERT INTO
                people
